...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-zl6npc\"]", document.head);
		...
		h: function hydrate() {
			...
			add_location(meta14, file, 21, 1, 1043);
			attr_dev(div0, "class", "overlay");
			add_location(div0, file, 26, 8, 1245);
			attr_dev(div1, "class", "background-image");
			set_style(div1, "background-image", "url(img/background.jpg)");
			add_location(div1, file, 25, 4, 1157);
			add_location(h1, file, 29, 8, 1322);
			attr_dev(a, "href", ".");
			add_location(a, file, 31, 40, 1413);
			attr_dev(li0, "class", "breadcrumb-item");
			add_location(li0, file, 31, 12, 1385);
			attr_dev(li1, "class", "breadcrumb-item");
			add_location(li1, file, 32, 12, 1451);
			attr_dev(ul, "class", "breadcrumb");
			add_location(ul, file, 30, 8, 1349);
			attr_dev(div2, "class", "header-text");
			add_location(div2, file, 28, 4, 1288);
			attr_dev(header, "class", "small-header");
			add_location(header, file, 24, 0, 1123);
			attr_dev(div3, "id", "portfolio-grid");
			attr_dev(div3, "class", "two-columns");
			add_location(div3, file, 39, 12, 1620);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 38, 8, 1590);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 37, 4, 1558);
			attr_dev(section, "id", "portfolio");
			add_location(section, file, 36, 0, 1529);
		},
		m: function mount(target, anchor) {
