...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-1ynxz6p\"]", document.head);
		...
		h: function hydrate() {
			...
			add_location(h1, file, 29, 8, 1168);
			attr_dev(a, "href", ".");
			add_location(a, file, 31, 40, 1259);
			attr_dev(li0, "class", "breadcrumb-item");
			add_location(li0, file, 31, 12, 1231);
			attr_dev(li1, "class", "breadcrumb-item");
			add_location(li1, file, 32, 12, 1297);
			attr_dev(ul, "class", "breadcrumb");
			add_location(ul, file, 30, 8, 1195);
			attr_dev(div2, "class", "header-text");
			add_location(div2, file, 28, 4, 1134);
			attr_dev(header, "class", "small-header");
			add_location(header, file, 24, 0, 969);
			attr_dev(div3, "id", "portfolio-grid");
			attr_dev(div3, "class", "two-columns");
			add_location(div3, file, 39, 12, 1466);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 38, 8, 1436);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 37, 4, 1404);
			attr_dev(section, "id", "portfolio");
			add_location(section, file, 36, 0, 1375);
		},
		m: function mount(target, anchor) {
