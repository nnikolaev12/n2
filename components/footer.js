function Footer()
{
    ...
    return (
        <footer className="text-center mt-10">
            <div>
                <a className="inline-block p-2 border border-black" href="https://www.linkedin.com/in/nikolay-nikolaev-78992268/" rel="nofollow noopener noreferrer">
                    <picture>
                ...
                <a className="inline-block p-2 border border-black" href="https://twitter.com/nnikolaev12" rel="nofollow noopener noreferrer">
                    <picture>
                ...
                <a className="inline-block p-2 border border-black" href="https://github.com/hitmanbg" rel="nofollow noopener noreferrer">
                    <picture>
                ...
                <a className="inline-block p-2 border border-black" href="https://stackoverflow.com/users/6769598/nikolay-nikolaev" rel="nofollow noopener noreferrer">
                    <picture>
